 ...
 */
export declare function loadTransformers(): Promise<TransformersLibrary>;
/**
 * @internal
 ...
 */
export declare function _setTransformersLoader(fn: (() => Promise<TransformersLibrary>) | undefined): void;
export {};
//# sourceMappingURL=transformersLoader.d.ts.map