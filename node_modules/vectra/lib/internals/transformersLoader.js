...
exports._setTransformersLoader = _setTransformersLoader;
let loader = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield Promise.resolve().then(() => __importStar(require('@huggingface/transformers')));
    }
    catch (_a) {
 ...
 */
function _setTransformersLoader(fn) {
    if (fn === undefined) {
        loader = () => __awaiter(this, void 0, void 0, function* () {
            try {
                return yield Promise.resolve().then(() => __importStar(require('@huggingface/transformers')));
            }
            catch (_a) {
